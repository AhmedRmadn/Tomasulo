...
import javax.swing.table.DefaultTableCellRenderer;    
    public class ReservationTableMUL {    
        JFrame frame;   
        JTable jt;
    
        ReservationTableMUL(JFrame frame , int x , int y){ 
        ...
        jt.getTableHeader().setBackground(new Color (64,128,128));
        ...
        public void update(int clk) {
    		reservationStationM mBuffer = ((reservationStationM)Luncher.c.hs.get(clk).get("MBuffer"));
    		reservationStationM.BufferCell [] buffer = mBuffer.buffer; 
