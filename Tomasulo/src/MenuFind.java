...
{
if(dialog==null)
	dialog=new MenuFind(FindReplaceDemo.this.ta);
...
/******************************************************/
public class MenuFind extends JPanel implements ActionListener
{
JTextArea jta;
