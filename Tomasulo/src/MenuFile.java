...
Luncher.frame.setTitle(fileName+" - "+applicationTitle);
...
fout.write(Luncher.codeEditor.ta.getText());
}
...
do
{
if(chooser.showSaveDialog(Luncher.frame)!=JFileChooser.APPROVE_OPTION)
	return false;
temp=chooser.getSelectedFile();
if(!temp.exists()) break;
if(   JOptionPane.showConfirmDialog(
		Luncher.frame,"<html>"+temp.getPath()+" already exists.<br>Do you want to replace it?<html>",
...
if(str==null)
break;
Luncher.codeEditor.ta.append(str+"\n");
}
...
updateStatus(temp,true);
Luncher.codeEditor.ta.setCaretPosition(0);
return true;
}
///////////////////////
void openFile()
...
do
{
if(chooser.showOpenDialog(Luncher.frame)!=JFileChooser.APPROVE_OPTION)
	return;
temp=chooser.getSelectedFile();
...
if(!saved)
{
int x=JOptionPane.showConfirmDialog(Luncher.frame,strMsg,applicationTitle,JOptionPane.YES_NO_CANCEL_OPTION);
