...
//// Buffer for addition and subtraction
public class reservationStationA {
	...
	class BufferCell {
		...
		public String toString() {
			return "BufferCell [position=" + position + ", tag=" + tag + ", busy=" + busy + ", op=" + op + ", VJ=" + VJ
					+ ", validVJ=" + validVJ + ", VK=" + VK + ", validVK=" + validVK + ", QJ=" + QJ + ", QK=" + QK
					+ ", time=" + time + ", running=" + running + ", complete=" + complete + "]";
		}
...
//	int time;
	...
	private double excute(int i) {
		if (buffer[i].op.equals("ADD.D")||buffer[i].op.equals("ADDI.D")) {
	...
	@Override
	public String toString() {
		return "ABuffer [size=" + size + ", buffer=" + Arrays.toString(buffer) + ", isFull=" + isFull + ", numOfIns="
				+ numOfIns + "]";
	}
	
	public reservationStationA copy() {
		reservationStationA c = new reservationStationA();
		c.size=this.size;
